    ...
    ";
      ...
      <nav class=\"breadcrumbs\">
        <ol>
          ...
          <li class=\"current\" style=\"color:var(--heading-color); font-weight:bold\">";
            // line 26
            echo twig_escape_filter($this->env, $this->getAttribute(($context["page"] ?? null), "title", []), "html", null, true);
            echo "</li>
        </ol>
    ...
    {% else %}
      ...
      <nav class=\"breadcrumbs\">
        <ol>
          ...
          <!-- Tiêu đề của trang hiện tại -->
          <li class=\"current\" style=\"color:var(--heading-color); font-weight:bold\">{{ page.title }}</li>
        </ol>
      </nav>
    {% endif %}
  </div>
</div><!-- End Page Title -->", "partials/place.html.twig", "C:\\xampp\\htdocs\\bookdevn\\user\\themes\\quark\\templates\\partials\\place.html.twig");
    }
}
