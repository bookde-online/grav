...
class __TwigTemplate_0cb55638092d5d534a1cb47acad569ca244400546d03fe17e25dc73cbf0ae247 extends \Twig\Template
{
    ...
    ";
      ...
      ";
                // line 15
                echo "      ";
                if ((($this->getAttribute($context["p"], "slug", []) == "home") || ($this->getAttribute($context["p"], "slug", []) == "trang-chu"))) {
                    // line 16
                    echo "          ";
            ...
            ";
                        ...
                        echo ((($this->getAttribute($context["p"], "slug", []) == "home")) ? ("home#services") : ("trang-chu#dich-vu"));
                        echo "\" class=\"";
    ...
    {% for p in page.children.visible %}
      ...
      {% if p.slug == 'home' or p.slug == 'trang-chu' %}
          {% if service_page.children.visible.count > 0 %}
          <li class=\"dropdown\">
            {% set is_service_active = page.activeChildOf('/home/_services') ? 'active' : '' %}
            <a href=\"{{ base_url_absolute }}{{ p.slug == 'home' ? 'home#services' : 'trang-chu#dich-vu' }}\" class=\"{{ is_service_active }}\">
