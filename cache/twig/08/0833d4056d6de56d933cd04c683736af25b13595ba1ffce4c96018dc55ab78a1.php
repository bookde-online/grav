...
/* vi/service-details.html.twig */
class __TwigTemplate_a4df41264806e5630cf9727b97e2754c75dc9ebd35955855912c1b62bbfdb516 extends \Twig\Template
{
...
<body class=\"service-details-page\">
  ...
  <header id=\"header\" class=\"header d-flex align-items-center sticky-top\">
    <div class=\"container position-relative d-flex align-items-center\">
      ...
      <nav id=\"navmenu\" class=\"navmenu\">
        ...
        echo "\" class=\"active\">Giải pháp tối ưu hóa đặt phòng</a></li>
            </ul>
          </li>
          <li><a href=\"";
        // line 59
  ...
  <main class=\"main\">
    ...
    <section id=\"service-details\" class=\"service-details section\">
      ...
      <div class=\"container\">
        ...
        // line 111
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["page"] ?? null), "find", [0 => "/service-details"], "method"), "url", []), "html", null, true);
        echo "\" class=\"active\">Trang web khách sạn tùy chỉnh</a>
              <a href=\"";
        // line 112
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["page"] ?? null), "find", [0 => "/service-details-1"], "method"), "url", []), "html", null, true);
        echo "\">Hỗ trợ đặt phòng trực tuyến</a>
              <a href=\"";
        // line 113
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute(($context["page"] ?? null), "find", [0 => "/service-details-2"], "method"), "url", []), "html", null, true);
        echo "\">Giải pháp tối ưu hóa đặt phòng</a>
            ...
            <h4>Tạo một nhận diện trực tuyến độc đáo với trang web tùy chỉnh.</h4>
            <p>Hãy tạo dấu ấn riêng cho thương hiệu của bạn với một trang web tùy chỉnh, thiết kế độc đáo và tối ưu trải nghiệm người dùng. Một giao diện chuyên nghiệp, chuẩn SEO và thân thiện với mọi thiết bị sẽ giúp bạn nổi bật trên môi trường trực tuyến, thu hút khách hàng và gia tăng uy tín thương hiệu.</p>
          </div>
        ...
        // line 121
        echo twig_escape_filter($this->env, ($context["theme_url"] ?? null), "html", null, true);
        echo "/assets/img/services/ser1.webp\" alt=\"Thiết kế website khách sạn\" class=\"img-fluid services-img\">
            <h3 style=\"display: flex; justify-content: center; text-align: center; margin: 10px;\">Trang web khách sạn tùy chỉnh</h3>
            <p>
              Dịch vụ của chúng tôi cung cấp cho các khách sạn cơ hội xây dựng trang web riêng của họ bằng cách sử dụng tên miền độc đáo.
            </p>
            <ul>
              <li><i class=\"bi bi-check-circle\"></i> <span>Đảm bảo một nét cá nhân hóa phản ánh đặc trưng riêng của họ.</span></li>
              <li><i class=\"bi bi-check-circle\"></i> <span>Thu hút nhiều đặt phòng trực tiếp hơn và xây dựng mối quan hệ khách hàng mạnh mẽ hơn.</span></li>
              <li><i class=\"bi bi-check-circle\"></i> <span>Nổi bật trong ngành khách sạn cạnh tranh với một trang web hoàn toàn phù hợp với thương hiệu của bạn.</span></li>
            </ul>
            <p>
  ...
  <script src=\"";
    ...
    {
        return "vi/service-details.html.twig";
    }
        ...
        <ul>
          ...
          <li class=\"dropdown\"><a href=\"{{ page.find('/home').url }}#services\"><span>Dịch vụ</span> <i class=\"bi bi-chevron-down toggle-dropdown\"></i></a>
            <ul>
              ...
              <li><a href=\"{{ page.find('/service-details-2').url }}\" class=\"active\">Giải pháp tối ưu hóa đặt phòng</a></li>
            </ul>
          </li>
    ...
    <section id=\"service-details\" class=\"service-details section\">
      ...
      <div class=\"container\">
        ...
        <div class=\"row gy-4\">
          ...
          <div class=\"col-lg-4\" data-aos=\"fade-up\" data-aos-delay=\"100\">
            <div class=\"services-list\">
              <a href=\"{{ page.find('/service-details').url }}\" class=\"active\">Trang web khách sạn tùy chỉnh</a>
              <a href=\"{{ page.find('/service-details-1').url }}\">Hỗ trợ đặt phòng trực tuyến</a>
          ...
          <div class=\"col-lg-8\" data-aos=\"fade-up\" data-aos-delay=\"200\">
            <img src=\"{{ theme_url }}/assets/img/services/ser1.webp\" alt=\"Thiết kế website khách sạn\" class=\"img-fluid services-img\">
            <h3 style=\"display: flex; justify-content: center; text-align: center; margin: 10px;\">Trang web khách sạn tùy chỉnh</h3>
            <p>
              Dịch vụ của chúng tôi cung cấp cho các khách sạn cơ hội xây dựng trang web riêng của họ bằng cách sử dụng tên miền độc đáo.
            </p>
...
</html>", "vi/service-details.html.twig", "C:\\wamp64\\www\\grav\\user\\themes\\mytheme\\templates\\vi\\service-details.html.twig");
    }
}
