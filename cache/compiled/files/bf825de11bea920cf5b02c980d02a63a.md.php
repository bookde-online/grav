...
return [
    ...
    'filename' => 'C:/xampp/htdocs/grav/user/pages/01.home/03._services/services.vi.md',
    'modified' => 1746430816,
    'size' => 3763,
    'data' => [
        'header' => [
...
Với thiết kế trực quan và chức năng tối ưu, thu hút nhiều khách hơn và tăng tỷ lệ lấp đầy. Đầu tư vào tương lai của khách sạn của bạn bằng cách thiết lập một sự hiện diện trực tuyến mạnh mẽ, phù hợp với đối tượng mục tiêu của bạn.',
        ...
        'frontmatter' => 'title: \'Nâng cao khách sạn của bạn trực tuyến\'
slug: dich-vu
template: modular/services
services:
    -
...
menu: \'Dịch vụ\'
visible: false',
        'markdown' => '_Khởi chạy trang web đặt phòng của riêng bạn hôm nay!_'
    ]
];
